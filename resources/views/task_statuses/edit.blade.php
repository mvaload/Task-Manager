...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white bg-primary">{{ __('messages.taskStatus.headerUpdate') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('task_statuses.update', $taskStatus->id) }}">
                        ...
                        <div class="form-group row mb-0 justify-content-between">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('task_statuses.destroy', $taskStatus->id) }}" class="btn btn-danger" data-method="delete" data-confirm="Are you sure you want to delete this task status?">
                                    {{ __('Delete') }}
                                </a>
                            </div>
                        </div>
